  ...
  if(isset($_POST['cbutton']))
{
	...
	$title=$_POST['cno'];	
	 $cemail=$_POST['cemail'];
	$data=mysqli_connect("localhost","root","","blog") or die(); 
	mysqli_query($data,"INSERT INTO contact VALUES('','$fname','$lname','$cemail','$title','$pst')");
...
<div class="date-posts">   
 ...
 <form action="contact.php" method="post">
  ...
  <input type="text" name="cfname" placeholder="First Name..." id="sbar">
   <input type="text" name="clname" placeholder="Last Name..." id="sbar">
    <input type="text" name="cemail" placeholder="Email..." id="sbar">
     <input type="text" name="cno" placeholder="Mobil No..." id="sbar">    
 	<textarea name="postupdate" cols="50" rows="5" placeholder="Description" class="postbar"></textarea> 
 	<button type="submit" id="cbtn" name="cbutton">Submit</button>
 </form>
